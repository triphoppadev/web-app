  ...
  return (
    <div className="w-full max-w-md bg-white rounded-3xl border border-[#e8d5e7] shadow-sm p-8">
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-[#392b75] mb-1.5">Email</label>
          <input
            type="email"
            value={email}
        ...
        <div>
          <label className="block text-sm font-medium text-[#392b75] mb-1.5">Password</label>
...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-[#f7f5ff] flex flex-col items-center justify-center px-4">
      <Suspense fallback={
        <div className="w-full max-w-md bg-white rounded-3xl border border-[#e8d5e7] shadow-sm p-8 flex items-center justify-center h-96">
          <span className="w-6 h-6 border-2 border-[#96298d]/30 border-t-[#96298d] rounded-full animate-spin" />
        </div>
      }>
        <LoginForm />
      </Suspense>
